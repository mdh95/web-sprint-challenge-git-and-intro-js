...
function listOfNames(array) {
  ...
  for (let i = 0; i < array.length; i++) {
    (copyofarray[i] = copyofarray[i].name)
  }
  return copyofarray;
}
...
function removeArtist(array, artist) {
  const copyofarray = [...array];
  for (let i = 0; i < array.length; i++) {
    if (i === artist) {
      array.splice(i, 1);
...
console.log('task 6', addArtist(artists, {
  ...
  years: "1995 to 2023",
  genre: "Web Design",
  nationality: "Ductch, French, Native American",
  bio: "My soul mate is my dog, Thumper.  I have never loved anything more."
}))
...
console.log('task 9:', artistByCountry(artists, 'Italian'));
